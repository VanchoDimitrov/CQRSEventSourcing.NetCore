...
public class ReservationsController: Controller
{
    ...
    public ReservationsController(ICommandBus commandBus, IQueryBus queryBus, IIdGenerator idGenerator)
    {
    ...
    public async Task<IActionResult> CreateTentative([FromBody] CreateTentativeReservationRequest request)
    {
        ...
        var command = CreateTentativeReservation.Create(reservationId, request.SeatId);
    ...
    public async Task<IActionResult> ChangeSeat(Guid id, [FromBody] ChangeSeatRequest request)
    {
        ...
        var command = ChangeReservationSeat.Create(id, request.SeatId);
    ...
    {
        var command = ConfirmReservation.Create(id);
    ...
    {
        var command = CancelReservation.Create(id);
