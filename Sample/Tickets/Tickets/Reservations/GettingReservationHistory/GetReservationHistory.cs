...
public record GetReservationHistory(Guid ReservationId, int PageNumber, int PageSize): IQuery<IPagedList<ReservationHistory>>
{
...
internal class HandleGetReservationHistory: IQueryHandler<GetReservationHistory, IPagedList<ReservationHistory>>
{
    ...
    public Task<IPagedList<ReservationHistory>> Handle(GetReservationHistory query, CancellationToken cancellationToken)
    {
