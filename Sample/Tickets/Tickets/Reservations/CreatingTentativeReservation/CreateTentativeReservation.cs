...
public record CreateTentativeReservation(Guid ReservationId, Guid SeatId): ICommand
{
...
internal class HandleCreateTentativeReservation: ICommandHandler<CreateTentativeReservation>
{
    ...
    public HandleCreateTentativeReservation(IMartenRepository<Reservation> repository, IReservationNumberGenerator reservationNumberGenerator, IMartenAppendScope scope)
    {
