...
public record ChangeReservationSeat(Guid ReservationId, Guid SeatId): ICommand
{
    public static ChangeReservationSeat Create(Guid? reservationId, Guid? seatId)
    {
        ...
        return new ChangeReservationSeat(reservationId.Value, seatId.Value);
    }
}

internal class HandleChangeReservationSeat: ICommandHandler<ChangeReservationSeat>
{
    private readonly IMartenRepository<Reservation> repository;
    private readonly IMartenAppendScope scope;

    public HandleChangeReservationSeat(IMartenRepository<Reservation> repository, IMartenAppendScope scope)
    {
