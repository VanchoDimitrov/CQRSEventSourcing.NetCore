...
public record GetReservations(int PageNumber, int PageSize): IQuery<IPagedList<ReservationShortInfo>>
{
...
internal class HandleGetReservations: IQueryHandler<GetReservations, IPagedList<ReservationShortInfo>>
{
