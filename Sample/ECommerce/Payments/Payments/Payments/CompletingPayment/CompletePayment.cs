...
public record CompletePayment(Guid PaymentId): ICommand
{
...
public class HandleCompletePayment: ICommandHandler<CompletePayment>
{
    ...
    public HandleCompletePayment(IMartenRepository<Payment> paymentRepository, IMartenAppendScope scope)
    {
