...
public class Order: Aggregate
{
    ...
    public static Order Initialize(Guid orderId, Guid clientId, IReadOnlyList<PricedProductItem> productItems, decimal totalPrice)
    {
        return new Order(orderId, clientId, productItems, totalPrice);
    }
    ...
    {
        var @event = OrderInitialized.Create(id, clientId, productItems, totalPrice, DateTime.UtcNow);
    ...
    {
        var @event = OrderPaymentRecorded.Create(Id, paymentId, ProductItems, TotalPrice, recordedAt);
